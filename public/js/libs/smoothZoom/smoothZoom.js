...
(function(g, h, k) {
    ...
    function j(o, q) {
        ...
        this.$elem = o;
        var s = g.extend({}, e, q);
        this.hideControls = s.hideControls;
        this.sW = s.width;
        this.sH = s.height;
    ...
    j.prototype = {
        ...
        //    }
            ...
            for (var U = 0; U < 7; U++) {
                C[U].$ob = g('<div style="position: absolute; display: ' + (U < 2 ? S ? "block": "none": y ? "block": "none") + "; left: " + (C[U].l - 1) + "px; top: " + (C[U].t - 1) + "px; width: " + (C[U].w + 2) + "px; height: " + (C[U].h + 2) + "px; z-index:" + (U + 1) + ';" class="noSel">						</div>').css("opacity", 0.7).on("mouseover.sz mouseout.sz " + o.event_down, {
                    id: U
                }, function(ab) {
                    o._onfocus = false;
                    $this = g(this);
            ...
            g(k).on(o.event_up + o.id, {
                self: o
            }, o.mouseUp);

            if ((o.mouse_drag && !a) || (o.touch_drag && a)) {
                if (a) {
                    o.$hitArea.on(o.event_down, {
                        self: o
                    }, o.mouseDown);
                    g(k).on(o.event_move + o.id, {
                        self: o
                    }, o.mouseDrag);
                } else {
                    o.$holder.on(o.event_down, {
                        self: o
                    }, o.mouseDown);
                }
            }
            if (o.mouse_dbl_click) {
                var T, Q, w = 1; (a ? o.$hitArea: o.$holder).on("dblclick.sz",
                function(ab) {
            ...
            R.on(o.event_down, function(ab) {
                ab.preventDefault();
                ab.stopPropagation()
            });
            if (o.mouse_dbl_click) {
                R.on("dblclick.sz", function(ab) {
                    ab.preventDefault();
                    ab.stopPropagation()
                });
            }
        ...
        setContainer: function() {
            ...
            if (m.responsive) {
                g(h).on("orientationchange.sz" + m.id + " resize.sz" + m.id, {
                    self: m
                },
                m.resize)
            }
        ...
        hideControl: function(){
            var me = this;
            me.$controls.stop().fadeOut(600);
        },

        showControl: function(){
            var me = this;
            me.$controls.stop().fadeIn(600);
        },
    ...
    var d = function(an, am, al) {
        ...
        function S(n, m, q) {
            for (var p in n) {
                var o = m[n[p]];
                if (o !== al) {
                    return q === !1 ? n[p] : Y(o, "function") ? o.on(q || m) : o
                }
            }
            return ! 1
        }
        ...
        M = function(w, v, u, t) {
            ...
            if (parseInt(u, 10)) {
                while (u--) {
                    q = am.createElement("div"),
                    q.id = t ? t[u] : ah + (u + 1),
                    p.appendChild(q)
                }
            }
            return s = ["&#173;", "<style>", w, "</style>"].join(""),
            p.id = ah,
            (o ? p: n).innerHTML += s,
            n.appendChild(p),
            o || (n.style.background = "", ai.appendChild(n)),
            r = v(p, w),
            o ? p.parentNode.removeChild(p) : n.parentNode.removeChild(n),
            !!r
        },
        K = {}.hasOwnProperty,
        J; ! Y(K, "undefined") && !Y(K.call, "undefined") ? J = function(n, m) {
            return K.call(n, m)
        }: J = function(n, m) {
            return m in n && Y(n.constructor.prototype[m], "undefined")
        },
        Function.prototype.on || (Function.prototype.on = function(m) {
            var p = this;
        ...
        var N = function(p, o) {
            ...
            function(v, u) {
                ...
                aj.touch = "ontouchstart" in an || an.DocumentTouch && am instanceof DocumentTouch || (q.touch && q.touch.offsetTop) === 9,
                aj.csstransforms3d = (q.csstransforms3d && q.csstransforms3d.offsetLeft) === 9 && q.csstransforms3d.offsetHeight === 3
            },
            m, o)
        ...
        X.csstransforms3d = function() {
            var m = !!Q("perspective");
            return m && "webkitPerspective" in ai.style && (m = aj.csstransforms3d),
            m
        };
        for (var L in X) {
        ...
        aj._prefixes = ac,
        aj._domPrefixes = Z,
        aj._cssomPrefixes = aa,
        aj.testProp = function(m) {
            return U([m])
        },
        aj.testAllProps = Q,
        aj.testStyles = M,
        aj.prefixed = function(n, m, o) {
